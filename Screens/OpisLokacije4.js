...
const OpisLokacije4 = () => {
  const parkingInfo = {
    naziv: "Parking kod motela",
    adresa: "9. januar, Milići",
    radnoVreme: "00-24h",
    cenaPoSatu: "Besplatno",
    ukupnoMesta: 30,
    status: "Turistički / Za goste motela",
    atrakcije: [
      "Motel Milići (20m)",
      "Restoran (20m)",
      "Benzinska pumpa (50m)",
      "Autobuska stanica (100m)",
      "Tržni centar (250m)"
    ]
  };

  const otvoriNavigaciju = () => {
    const url = `google.navigation:q=44.167792,19.075389`;
    Linking.openURL(url)
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>🚌 Parking za autobuse: Da</Text>
