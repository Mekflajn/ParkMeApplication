...
const OpisLokacije3 = () => {
  const parkingInfo = {
    naziv: "Parking kod sportskog centra",
    adresa: "NIkole Tesle 34, Milići",
    radnoVreme: "00-24h",
    ...
    atrakcije: [
      "Sportski centar (20m)",
      "Teniski tereni (50m)",
      "Fudbalski teren (100m)",
      "Sportska dvorana (100m)",
      "Teretana (100m)",
      "Gradski bazen (350m)",
    ]
  };
  ...
  const otvoriNavigaciju = () => {
    const url = `google.navigation:q=44.165087,19.070426`;
    Linking.openURL(url)
